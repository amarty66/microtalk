var NANOLISP = (function() {
  ...
  // NANOLISP by Alain Marty | updated on 2015/09/12
...
// 2) maths: 
dict['lt'] = dict['<'] = function() {
  return arguments[0] < arguments[1]
};
dict['gt'] = dict['>'] = function() {
  return arguments[0] > arguments[1]
};
dict['='] = function() {
...
var mathtags = ['abs', 'acos', 'asin', 'atan', 'ceil', 'cos', 'exp', 'floor', 'log', 'random', 'round', 'sin', 'sqrt', 'tan', 'min', 'max'];
...
// 3) html:
// 3.1) if nanolisp is out of alphawiki:
/*
var htmltags = ['div', 'span', 'a', 'ul', 'ol', 'li', 'dl', 'dt', 'dd', 'table', 'tr', 'td', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'p', 'b', 'i', 'u', 'center', 'br', 'hr', 'blockquote', 'sup', 'sub', 'del', 'code', 'img'];
...
// 3.2) if nanolisp is in alphawiki:
var htmltags = ['@', 'div', 'span', 'a', 'ul', 'ol', 'li', 'dl', 'dt', 'dd', 'table', 'tr', 'td', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'p', 'b', 'i', 'u', 'center', 'br', 'hr', 'blockquote', 'sup', 'sub', 'del', 'code', 'img'];
...
for (var i=0; i< htmltags.length; i++) {
  dict[htmltags[i]] = function(tag) {
    return function() {
      ...
      return MICROTALK.eval_simple_forms(str);  
    }
  }(htmltags[i]);  
}

// 4) evaluation, where everything is handled:
...
function display() { 
  ...
  if (output.val != '')
    document.getElementById('output').innerHTML =
      output.val;
  document.getElementById('parser_infos').innerHTML = 
    output.infos[2] + ' ms (' + 
